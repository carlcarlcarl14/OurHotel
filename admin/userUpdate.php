            ...
            <div class="container bg-light" style="box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
               <div class="row">
                  ...
                  if (isset($_POST['update'])) {
                     ...
                     $sql_select = "SELECT * FROM users WHERE id = '$new_id'";
                     ...
                     if ($user_num_rows > 0 && $username !== $current_username) {
                        ...
                        if ($email_num_rows > 0 && $email !== $current_email) {
                           ...
                           if ($password !== $cpassword) {
                              ...
                              $sql = "UPDATE users SET  email ='$email',username = '$username', password = '$password' WHERE id = '$new_id'";
                              $query = mysqli_query($conn, $sql);
                              if (!$query) {
                  ...
                  <form action="userUpdate.php?new_id=<?php echo $id ?>" method="post" class="p-5">
                     ...
                     <div class="form-btn">
                        ...
                        <button class="btn btn-secondary float-end"><a href="users.php" class="text-decoration-none text-light">Cancel</a></button>
                     </div>
                  </form>
               </div>
            </div>

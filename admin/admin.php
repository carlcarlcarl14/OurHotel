            ...
            <div class=" p-2">
               ...
               <ul class="nav nav-pills flex-column mt-4 d-flex justify-content-center">
                  ...
                  <li class="nav-item py-2 py-sm-0 text-center mb-3">
                     <a href="dashboard.php" class="nav-link text-white gradient-link">
                        <i class="d-inline fa fa-gauge"></i><span class=" ms-3 d-none d-md-inline">Dashboard</span>
                     </a>
                  </li>
                  <li class="nav-item py-2 py-sm-0 text-center mb-3">
                     <a href="admin.php" class="nav-link text-white gradient-link">
                              ...
                              if ($email_num_rows > 0) {
                                 ...
                                 if ($password !== $confirm_password) {
                                    ...
                                    if ($query) {
                                       ...
                                       $_SESSION['failed'] = "Failed to add admin, please try again.";
                                       header('Location: admin.php');
                                    }
                                 }
                              }
                           ...
                           if ($num_rows == 0) {
                              ...
                              while ($row = mysqli_fetch_assoc($query)) {
                                 ...
                                 echo '<tr>
                                       ...
                                       <td>
                                          <button class="btn btn-primary" type="button"><a href="adminUpdate.php?updateid=' . $admin_id . '" class="text-light text-decoration-none">Update</a></button>
                                          <button class="btn btn-danger"><a href="adminDelete.php? deleteid=' . $admin_id . '" class="text-light text-decoration-none">Delete</a></button>
                                       </td>
                                    </tr>';
                              }
                           }
